...
int send_code (const int fd, char *code, const char *file)
{
    ...
    if (strcmp (code, "200") == 0)
    {
        ...
        char content_length[1024] = "Content-Length: ";
    ...
    else if (strcmp (code, "404") == 0)
    {
        ...
        char *msg404 = "<html><head><title>404 Not Found</head></title><body><p>404 Not Found: The requested resource could not be found!</p></body></html>";
...
int send_file (const int fd, const int file_fd, int file_size)
{
    ...
    while (total_bytes_sent < file_size)
    {
        ...
        if(bytes_sent = sendfile(fd, file_fd, 0, file_size - total_bytes_sent) <= 0)
        {
